...
struct T { int sign,d[N],i1,i2; T(){sign=0;}};
...
{  int i,t,carry=0; n.sign=!n.sign; //符号正负切换
   ...
   if (!isZero(n)&&!n.d[n.i1]) n.i1++; //最高位为0时总计少了1位
   return n;
}
...
int main()
{  T n{}; string s;  cin>>s; string::iterator p=s.begin();
   if (*p=='+'||*p=='-')  { if (*p=='-') n.sign=1; p++; }
   n.i1=n.i2=1; while (p!=s.end()) n.d[n.i2++]=*p++-'0'; n.i2--;
