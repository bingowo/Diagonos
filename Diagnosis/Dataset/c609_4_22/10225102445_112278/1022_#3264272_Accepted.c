...
{struct F stu[A];
for(i=0;i<A;i++)
{ stu[i].a=(char*)malloc(sizeof(char)*30000);
    scanf("%s",stu[i].a);
    stu[i].b=(char*)malloc(sizeof(char)*strlen(stu[i].a));
stu[i].c=(char*)malloc(sizeof(char)*strlen(stu[i].a));
}
for(i=0;i<A;i++)
...
{ struct F stu[A];
for(i=0;i<A;i++)
{ stu[i].a=(char*)malloc(sizeof(char)*30);
    scanf("%s",stu[i].a);
    stu[i].b=(char*)malloc(sizeof(char)*strlen(stu[i].a));
stu[i].c=(char*)malloc(sizeof(char)*strlen(stu[i].a));
}
...
else if (A==1){char s[1000000] ;scanf("%s",s);printf("%s",s);}
