...
int main(void)
{
	...
	char input_1[INPUTMAX],input_2[INPUTMAX];//输入定义
	while((scanf("%s %s",input_1,input_2))!=EOF)//输入嵌套循环
	{
    ...
    0},
		n2[NMAX]={
    0},
		i,coe,exp,pro,sig;//coe系数，exp次数，pro进程，sig符号
		
		int length_n1=strlen(input_1),length_n2=strlen(input_2);//获取字符串长度
