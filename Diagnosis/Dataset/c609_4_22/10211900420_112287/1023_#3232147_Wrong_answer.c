...
{
    int i,j=0,k=0,l=0;
    char *date1=*(char**)a,*date2=*(char**)b,day1[3]={0},day2[3]={0},month1[10]={0},month2[10]={0},year1[5]={0},year2[5]={0};
    ...
    for(i=0;i<strlen(date2);i++)
    {
        ...
        if(date2[i]=='.') { day2[l]='\0'; break;}

    }
    j=0;k=0;l=0;
    for(i=i+2;i<strlen(date2);i++)
    {
        if(date2[i]!=' ')
        {
            month2[j]=date2[i];
