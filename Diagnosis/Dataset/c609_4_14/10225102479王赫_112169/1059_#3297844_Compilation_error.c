...
{
    num_positive *a=(num_positive*)_a,num_positive *b=(num_positive*)_b;
...
{
    num_passive *a=(num_passive*)_a,num_passive *b=(num_passive*)_b;
...
int main()
{
    int n;
    scanf("%d",&n);
    num_positive m[n]= {0,{0},{0}};
    num_passive p[n]={0,{0},{0}};
    ...
    qsort(m,len_po,sizeof(num_positive),cmp_positive);
    qsort(m,len_pa,sizeof(num_passive),cmp_passive);
