...
int main()
{
    ...
    if(s <= val[i].drop * val[i].breadth)
    {
        ...
        int son = s/common;
        int mother = val[i].breadth/common;
        if(mother == 1)
            printf("%d",valley[0] + son/mother);
        else
        {
            int plus = son/mother;
            son -= plus*mother;
            printf("%d+%d/%d",valley[0] + plus,son,mother);
        }
    ...
    if(val[i].breadth/common == 1)
    ...
    else
        {
            ...
            int plus = son/mother;
            son -= plus*mother;
            printf("%d+%d/%d",height + plus,son,mother);
        }
    free(valley);
    free(val);
    return 0;
