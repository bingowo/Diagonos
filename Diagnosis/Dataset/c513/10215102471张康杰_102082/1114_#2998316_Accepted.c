...
int main()
{
    ...
    {
        int common = GCD(abs(exp[2]),abs(exp[1]));
        if(common < exp[2] / common)
            printf("%d %d %d %d\n",common,0,exp[2] / common,exp[1] / common);
        else if(common > exp[2] / common)
            printf("%d %d %d %d\n",exp[2] / common,exp[1] / common,common,0);
        else
        {
            if(exp[1] / common < 0)
                printf("%d %d %d %d\n",exp[2] / common,exp[1] / common,common,0);
