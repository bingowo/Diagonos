...
BigInt Mul(BigInt q,BigInt r){
    ...
    if(key.v[key.cnt-1]==0&&key.cnt>1)key.cnt--;
    if(q.flag!=r.flag&&compare1(q,Int2Big(0))!=0&&compare1(r,Int2Big(0))!=0)key.flag=-1;
    else key.flag=1;
    return key;
}
fushu Mulu(fushu u1,fushu u2){
    fushu u;
    BigInt c,b2,a2;
    c=Mul(u1.b1,u2.b1);
    b2=Add(Mul(u1.b1,u2.a1),Mul(u1.a1,u2.b1));
    a2=Mul(u1.a1,u2.a1);
    a2=Sub(a2,c);
    u.a1=a2,u.b1=b2;
    return u;
}
fushu Pow(BigInt a,BigInt b,long long int k){
    fushu u;
    if(k==0){u.a1=Int2Big(1),u.b1=Int2Big(0);return u;}
    else if(k==1){u.a1=a,u.b1=b;return u;}
    fushu u1;
    u1.a1=a,u1.b1=b;
    u=Pow(a,b,k/2LL);
    u=Mulu(u,u);
    if(k%2LL)u=Mulu(u,u1);
    return u;
}
...
int main(){
    ...
    BigInt a=Int2Big(a3),b=Int2Big(b3),zero=Int2Big(0);
    fushu u;
    u=Pow(a,b,k);
    a=u.a1,b=u.b1;
    if(Compare(b,zero)<0){
