...
BIG mul(BIG T, BIG S){
    ...
    if(temp1.Rcnt > 0 && temp1.Rv[temp1.Rcnt - 1] == 0) temp1.Rcnt--;
    ...
    if(temp2.Rcnt > 0 && temp2.Rv[temp2.Rcnt - 1] == 0) temp2.Rcnt--;
    ...
    if(temp3.Icnt > 0 && temp3.Iv[temp3.Icnt - 1] == 0) temp3.Icnt--;
    ...
    if(temp4.Icnt > 0 && temp4.Iv[temp4.Icnt - 1] == 0) temp4.Icnt--;
