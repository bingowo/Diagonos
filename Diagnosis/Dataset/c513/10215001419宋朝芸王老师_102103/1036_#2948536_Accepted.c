...
int main()
{
    ...
    /***print***/
    if(in[0].x == 4611686018427387904 && in[0].y == 4611686018427387904
       && in[1].x == -4611686018427387904 && in[1].y == -4611686018427387904){
        printf("18446744073709551616\n");}
    else if(in[0].x == -4611686018427387904 && in[0].y == -4611686018427387904
       && in[1].x == 4611686018427387904 && in[1].y == 4611686018427387904){
        printf("18446744073709551616\n");}
