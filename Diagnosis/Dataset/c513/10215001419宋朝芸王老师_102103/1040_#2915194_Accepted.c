...
void getpar(char *a1, char *a2, char *a3){   //a1 is unknown
    ...
    if(f == 44) {strcpy(a1,"{A,B,O}");return 0;}
    else if(f == 13 || f == 42 || f == 12) {strcpy(a1,"{AB,B}");return 0;}
    else if(f == 23 || f == 41 || f == 21) {strcpy(a1,"{A,AB}");return 0;}
    ...
    else if(f == 31 || f == 32 || f == 11 || f == 22) {strcpy(a1,"{A,AB,B,O}");return 0;}
    else if(f == 14 || f == 24) {strcpy(a1,"{A,B,O}");return 0;}
