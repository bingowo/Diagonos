...
int main()
{
    ...
    for(i=0;i<T;i++)
    {
        ...
        for(j=0;j<l;j++)
        {
                 if((j==l-1)&&((a[l-1]>='a'&&a[l-1]<='z')||(a[l-1]>='A'&&a[l-1]<='Z')))
                {
                    for(k=v,g=0;k<=j;k++,g++)
                    {
                        b[t][g]=a[k];
                ...
                else if((j==l-1)&&(a[j]==','||a[j]=='.'||a[j]=='!'||a[j]=='?'))
                {
                ...
                else  if(isspace(a[j]))
                 {
                     ...
                     else if((a[v+1]>='a'&&a[v+1]<='z')||(a[v+1]>='A'&&a[v+1]<='Z'))
                     {
                         v=v+1;
                         for(k=v,g=0;k<j;k++,g++)
                        {
                 ...
                 else if(a[j]==','||a[j]=='.'||a[j]=='!'||a[j]=='?')
                {
                   if((a[v]>='a'&&a[v]<='z')||(a[v]>='A'&&a[v]<='Z'))
                   {
                      ...
                      else if((a[j+1]>='a'&&a[j+1]<='z')||(a[j+1]>='A'&&a[j+1]<='Z'))
                      {
                       for(k=v,g=0;k<j;k++,g++)
                       {
                        b[t][g]=a[k];
