...
int main(){
    ...
    while(now<num){
        ...
        if(s[1]==' '&&s[i+1]!='\0'){
            if(s[i-1]=='a') break;
            else if(s[i-1]=='A') break;
            else sum++;
        }
        if(s[2]==' '&&s[i+1]!='\0'){
            if(s[i-1]=='n'&&s[i-2]=='a')break;
            else if(s[i-1]=='n'&&s[i-2]=='A')break;
            else if(s[i-1]=='N'&&s[i-2]=='a')break;
            else if(s[i-1]=='N'&&s[i-2]=='A')break;
            else if(s[i-1]=='f'&&s[i-2]=='o')break;
            else if(s[i-1]=='F'&&s[i-2]=='o')break;
            else if(s[i-1]=='f'&&s[i-2]=='O')break;
            else if(s[i-1]=='F'&&s[i-2]=='O')break;
            else sum++;
        ...
        if(s[3]==' '&&s[i+1]!='\0'){
            if(s[i-1]=='a'&&s[i-2]==' ')break;
            else if(s[i-1]=='A'&&s[i-2]==' ')break;
            else if(s[i-1]=='e'&&s[i-2]=='h'&&s[i-3]=='t')break;
            else if(s[i-1]=='e'&&s[i-2]=='h'&&s[i-3]=='T')break;
            else if(s[i-1]=='e'&&s[i-2]=='H'&&s[i-3]=='T')break;
            else if(s[i-1]=='e'&&s[i-2]=='H'&&s[i-3]=='t')break;
            else if(s[i-1]=='E'&&s[i-2]=='h'&&s[i-3]=='t')break;
            ...
            else if(s[i-1]=='r'&&s[i-2]=='o'&&s[i-3]=='f')break;
            else if(s[i-1]=='r'&&s[i-2]=='o'&&s[i-3]=='F')break;
            else if(s[i-1]=='r'&&s[i-2]=='O'&&s[i-3]=='F')break;
            else if(s[i-1]=='r'&&s[i-2]=='O'&&s[i-3]=='f')break;
            else if(s[i-1]=='R'&&s[i-2]=='o'&&s[i-3]=='f')break;
            ...
            else if(s[i-1]=='d'&&s[i-2]=='n'&&s[i-3]=='a')break;
            else if(s[i-1]=='d'&&s[i-2]=='n'&&s[i-3]=='A')break;
            else if(s[i-1]=='d'&&s[i-2]=='N'&&s[i-3]=='A')break;
            else if(s[i-1]=='d'&&s[i-2]=='N'&&s[i-3]=='a')break;
            else if(s[i-1]=='D'&&s[i-2]=='n'&&s[i-3]=='A')break;
