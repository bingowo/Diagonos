...
int isMathOperation(char* s){
    if(strcmp(s,"ADD")==0||strcmp(s,"SUB")==0||strcmp(s,"MUL")==0||strcmp(s,"DIV")==0||strcmp(s,"MOV")==0){
        return 1;
    }
    return 0;
}
...
int main()
{
    ...
    while(1){
        ...
        if(strcmp(curOperation,"IN")==0){
            ...
            if(strcmp(curOperation,"MOV")==0){(*n1) = (*n2);}
            else if(strcmp(curOperation,"ADD")==0){(*n1) = (*n1) + (*n2);}
