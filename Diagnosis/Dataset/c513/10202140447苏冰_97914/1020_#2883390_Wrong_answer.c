...
int main()
{
    ...
    while(n!=0)
    {
        ...
        gets(a);
        gets(a);
        if(strcmp(a,"LIST /NAME")==0) qsort(s,n,sizeof(stu),cmp1);
        else if(strcmp(a,"LIST /SIZE")==0) qsort(s,n,sizeof(stu),cmp2);
        else if(strcmp(a,"LIST /TIME")==0) qsort(s,n,sizeof(stu),cmp3);
        for(int i=0;i<n;i++)
        {
