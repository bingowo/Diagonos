...
int main()
{
    ...
    for(int i=0;i<digit;i++){
        ...
        char zhonga1[10000]={0},zhongb1[10000]={0};
        strcpy(zhonga1,a1);
        strcpy(zhongb1,b1);
    ...
    if(len2>2) {
        ...
        if(b[1]=='1'&&k==1) printf("%ci",b[0]);
            ...
            for(;ww<len2;ww++){
                int qq=0;
                if(ky==0,b[ww]!='0') {ky=1;printf("%c",b[0]);qq=1;}
                if(ky==1) {
                    if(ww!=len2-1) printf("%c",b[ww]);
                    else if(ww==len2-1&&qq!=1) printf("%c",b[ww]);
                }
                if(ww==len2-1&&ky==1) printf("i");
            }
            ...
            for(;ww<len2;ww++){
                int qq=0;
                if(ky==0,b[ww]!='0') {ky=1;if(b[0]=='-') printf("-");qq=1;}
                if(ky==1) {
                    if(ww!=len2-1) printf("%c",b[ww]);
                    else if(ww==len2-1&&qq!=1) printf("%c",b[ww]);
                }
