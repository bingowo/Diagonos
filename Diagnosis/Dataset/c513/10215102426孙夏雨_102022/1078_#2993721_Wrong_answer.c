                ...
                if(left>=right&&right<=s/2){
                    ...
                    if(sheng==0||sheng==1){
                        ...
                        if(l>mul){
                            ...
                            int e=zil/mul;
                            zil=zil%mul;
                            if(zil==0) {for(int i=wei+1;i<wei1;i++) printf("%d ",a[i]+e);}
                            else {for(int i=wei+1;i<wei1;i++) printf("%d+%d/%d ",a[i]+e,zil,mul);}
                    ...
                    while(r>0){
                        ...
                        if(r>mul){
                            ...
                            int e=zil/mul;
                            zil=zil%mul;
                            if(zil>0) {for(int i=wei1+1;i<wei;i++) printf("%d+%d/%d ",a[i]+e,zil,mul);}
                            else {for(int i=wei1+1;i<wei;i++) printf("%d ",a[i]+e);}
                            for(int i=wei;i<n;i++) printf("%d ",a[i]);
                            printf("\n");
                        }
                    }
