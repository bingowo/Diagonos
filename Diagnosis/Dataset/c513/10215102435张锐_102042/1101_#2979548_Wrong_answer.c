...
int main()
{
    ...
    for(int i=0;i<n;i++)
    {
        ...
        if(strcmp(son,"?")==0)
        {
            ...
            if(((fa[0]=='A'&&strlen(fa)==2)||strlen(fa)==3||fa[0]=='B')&&strlen(ma)==2&&bo==1) printf("%s %s {A-,AB-,B-}",fa,ma);
            else if(((fa[0]=='A'&&strlen(fa)==2)||strlen(fa)==3||fa[0]=='B')&&strlen(ma)==2&&bo==0) printf("%s %s {A+,A-,AB+,AB-,B+,B-}",fa,ma);
            else if(((ma[0]=='A'&&strlen(ma)==2)||strlen(ma)==3||ma[0]=='B')&&strlen(fa)==2&&bo==1) printf("%s %s {A-,AB-,B-}",fa,ma);
            else if(((ma[0]=='A'&&strlen(ma)==2)||strlen(ma)==3||ma[0]=='B')&&strlen(fa)==2&&bo==0) printf("%s %s {A+,A-,AB+,AB-,B+,B-}",fa,ma);
            ...
            else if((fa[0]=='O'&&strlen(ma)==3)||(ma[0]=='O'&&strlen(fa)==3)&&bo==1) printf("%s %s {A-,B-}\n",fa,ma);
            else if((fa[0]=='O'&&strlen(ma)==3)||(ma[0]=='O'&&strlen(fa)==3)&&bo==0) printf("%s %s {A+,A-,B+,B-}\n",fa,ma);
