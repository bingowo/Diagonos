    ...
    else if(b[0]=='-')//a+b
    {
        ...
        if(len1>=len2)//a
        {
            ...
            for(int i=len1-1,j=len2-1;i>=0;j--,i--)
            {
                ...
                int temp=(a[i]-'0')+(bb-'0')+last;
                if(temp<=9) a[i]=temp+'0',last=0;
                else if(temp>9)
                {
                    a[i]=temp-10+'0';last=1;
                }
            }
            if(last==1) printf("1");
            return a;
        ...
        else//b
        {
            ...
            for(int i=len2-1,j=len1-1;i>=0;j--,i--)
            {
                ...
                int temp=(b[i]-'0')+(aa-'0')+last;
                if(temp<=9) b[i]=temp+'0',last=0;
                else if(temp>9)
                {
                    b[i]=temp-10+'0';last=1;
                }
            }
            if(last==1) printf("1");
            return b;
