...
int main()
{
    ...
    if(strcmp(fa,"?")==0)
    {
        if(ma[0]=='A'&&strlen(ma)==1&&son[0]=='A') printf("{A,AB,B,O} %s %s",ma,son);
        ...
        else if(strlen(ma)==2&&son[0]=='A') printf("{A,AB,B,O} %s %s",ma,son);
        else if(strlen(ma)==2&&son[0]=='B') printf("{A,AB,B,O} %s %s",ma,son);
        else printf("impossible %s %s\n",ma,son);
    }
    if(strcmp(ma,"?")==0)
    {
        if(fa[0]=='A'&&strlen(fa)==1&&son[0]=='A') printf("%s {A,AB,B,O} %s",fa,son);
