...
int main()
{
    int t;
    scanf("%d",&t);
    static char sa[]=".-",sb[]="-...",sc[]="-.-.",sd[]="-..",se[]=".",sf[]="..-.";
    static char sg[]="--.",sh[]="....",si[]="..",sj[]=".---",sk[]="-.-.",sl[]=".--.",sm[]="--",sn[]="-.",so[]="---",sp[]=".--.",sq[]="--.-",sr[]=".-.",ss[]="...",st[]="-",su[]="..-";
    static char sv[]="...-",sw[]=".--",sx[]="-..-";
    static char sy[]="-.--",sz[]="--..",s0[]="-----",s1[]=".----",s2[]="..---",s3[]="...--",s4[]="....-",s5[]=".....",s6[]="-....",s7[]="--...",s8[]="---..",s9[]="----.";
    for(int f=0;f<t;f++)
    {
        char s[1006];
        scanf("%s",s);
        int len=strlen(s);
        char temp[10]={'0'};int j=0;
        printf("case #%d:\n",f);
        for(int i=0;i<len;i++)
        {
            j=0;
