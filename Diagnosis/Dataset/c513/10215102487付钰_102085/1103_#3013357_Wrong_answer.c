...
int main()
{
    ...
    while(1){
        ...
        if(strcmp(ch,"IN")==0){
            ...
            if(strcmp(reg_str1,"AX")==0) reg2=&ax;
            if(strcmp(reg_str1,"BX")==0) reg2=&bx;
            if(strcmp(reg_str1,"CX")==0) reg2=&cx;
            if(strcmp(reg_str1,"DX")==0) reg2=&dx;

            if(strcmp(ch,"MOV")==0) *reg1=*reg2;
            if(strcmp(ch,"ADD")==0) *reg1=(*reg2)+(*reg1);
            if(strcmp(ch,"SUB")==0) *reg1=(*reg1)-(*reg2);
            if(strcmp(ch,"MUL")==0) *reg1=(*reg2)*(*reg2);
