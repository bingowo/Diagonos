...
int main(void)
{
    int op1 = 0, op2 = 0;
    lli  temp[VECTOR];
    memset(temp, 0, sizeof(lli) * VECTOR);
    ...
    while(line > 0){
        ...
        switch (type) {
            ...
            case '+':
                ...
                op1 = val_pop();
                op2 = val_pop();
                for(int j = 0 ; map[op1][j] != 0 || map[op2][j] != 0 ; j ++){
                    if(map[op1][j] == 0){
            ...
            case '/':
                ...
                op1 = val_pop();
                int j = 0;
                lli tempnum = map[val_sp][0];
                if(buf[buf_p] == '+'){
                    for(j = 1; map[op1][j] != 0; j ++){
                        tempnum += map[op1][j];
                    }
                }else if(buf[buf_p] == '-'){
                    for(j = 1; map[op1][j] != 0; j ++){
