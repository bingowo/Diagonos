...
int main()
{
    ...
    if(gene[2][0] == '?')
    {
       ...
       else if(gene[0][0] == 'B'&&gene[0][1] == '\0')//父亲为B；
       {
           ...
           else if(gene[1][0] == 'B'&&gene[1][1] == '\0'){printf("%s %s {B,O}",gene[0],gene[1]);}//母亲为O;
       }
       ...
       else if(gene[1][0] == 'B'&&gene[1][1] == '\0')//父亲为B；
       {
    ...
    else if(gene[0][0] == '?')
    {
        if(gene[1][0] == 'A'&&gene[1][1] == '\0')//母亲为A;
        {
            ...
            else if(gene[2][0] == 'O'&&gene[2][1] == '\0'){printf("{A,O} %s %s",gene[1],gene[2]);}//孩子为O;
        }
         else if(gene[1][0] == 'B'&&gene[1][1] == '\0')//母亲为B;
        {
            ...
            else if(gene[2][0] == 'O'&&gene[2][1] == '\0'){printf("{B,O} %s %s",gene[1],gene[2]);}//孩子为O;
        }
        else if(gene[1][0] == 'A'&&gene[1][1] == 'B')//母亲为AB;
        {
             if(gene[2][0] == 'A'&&gene[2][1] == '\0'){printf("{A,AB,B,O} %s %s",gene[1],gene[2]);}//孩子为A;
        ...
        else if(gene[1][0] == 'O'&&gene[1][1] == '\0')//母亲为O;
        {
            ...
            else if(gene[2][0] == 'O'&&gene[2][1] == '\0'){printf("{O} %s %s",gene[1],gene[2]);}//孩子为O;
        }
    }
    ...
    else if(gene[1][0] == '?')
    {
        if(gene[0][0] == 'A'&&gene[0][1] == '\0')//父亲为A;
        {
            ...
            else if(gene[2][0] == 'O'&&gene[2][1] == '\0'){printf("%s {A,O} %s",gene[0],gene[2]);}//孩子为O;
        }
         else if(gene[0][0] == 'B'&&gene[0][1] == '\0')//父亲为B;
        {
            ...
            else if(gene[2][0] == 'O'&&gene[2][1] == '\0'){printf("%s {B,O} %s",gene[0],gene[2]);}//孩子为O;
        }
        else if(gene[0][0] == 'A'&&gene[0][1] == 'B')//父亲为AB;
        {
             if(gene[2][0] == 'A'&&gene[2][1] == '\0'){printf("%s {A,AB,B,O} %s",gene[0],gene[2]);}//孩子为A;
        ...
        else if(gene[0][0] == 'O'&&gene[0][1] == '\0')//父亲为O;
        {
            ...
            else if(gene[2][0] == 'O'&&gene[2][1] == '\0'){printf("%s {O} %s",gene[0],gene[2]);}//孩子为O;
        }
    }
