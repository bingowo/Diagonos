...
int main()
{
    int i,j = 26,k,l,h,h1,h2,h3,sign = 1,d;
    long long sum;
    char imp[20],s[4],ele1[20],ele2[20],ele3[20];
    ...
    while(scanf("%s",s)!=EOF)
    {
        ...
        else if(strcmp(s,s3) == 0)
        {
            ...
            if(strlen(ele3))cp[h1].num = cp[h2].num + cp[h3].num;
