...
int main()
{
    ...
    for(i=0;i<n;i++)
    {
        ...
        if(t[21].num>0)
        {
            if(t[5].num>=t[21].num&&t[8].num>=t[21].num&&t[4].num>=t[21].num)
            {
                if(k) for(l=0;l<t[21].num;l++,k++) code[k]=5;
                else for(k=0;k<t[21].num;k++) code[k]=5;
                t[5].num-=t[21].num;
                t[8].num-=t[21].num;
                t[4].num-=t[21].num;
            }
        ...
        if(t[5].num>0)
        {
            if(t[14].num>=t[5].num&&t[20].num>=t[5].num&&t[17].num>=t[5].num)
            {
                if(k) for(l=0;l<t[5].num;l++,k++) code[k]=4;
                else for(k=0;k<t[5].num;k++) code[k]=4;
                t[14].num-=t[5].num;
                t[20].num-=t[5].num;
                t[17].num-=t[5].num;
            }
        ...
        if(t[7].num>0)
        {
            if(t[19].num>=t[7].num&&t[17].num>=t[7].num&&t[5].num>=2*t[7].num)
            {
        ...
        if(t[19].num>0)
        {
            if(t[22].num>=t[19].num&&t[14].num>=t[19].num)
            {
                if(k) for(l=0;l<t[19].num;l++,k++) code[k]=2;
                else for(k=0;k<t[19].num;k++) code[k]=2;
                t[22].num-=t[19].num;
                t[14].num-=t[19].num;
            }
        }
        ...
        if(t[4].num>0)
        {
            if(t[13].num>=2*t[4].num&&t[8].num>=t[4].num)
            {
                if(k) for(l=0;l<t[4].num;l++,k++) code[k]=9;
                else for(k=0;k<t[4].num;k++) code[k]=9;
                t[13].num-=t[4].num;
                t[8].num-=t[4].num;
            }
        }
