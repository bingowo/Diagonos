...
int main()
{
    ...
    if(gene[2][0] == '?')
    {
       ...
       {
           if(gene[1][0] == 'B'&&gene[1][1] == '\0'){printf("%s %s {B,O}",gene[0],gene[1]);}//母亲为B;
           else if(gene[1][0] == 'A'&&gene[1][1] == '\0'){printf("%s %s {A,O}",gene[0],gene[1]);}//母亲为A;
           else if(gene[1][0] == 'A'&&gene[1][1] == 'B'){printf("%s %s {A,B}",gene[0],gene[1]);}//母亲为AB;
       }
}
