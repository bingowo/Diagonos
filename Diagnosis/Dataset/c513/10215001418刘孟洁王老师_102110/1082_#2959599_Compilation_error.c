...
void read1(char s[])
{
    ...
    for(i = 0;i < len; i++)
       ...
       else if(k == len-1){for(j = 0; j < len-1; j++)s1[j] = ‘0';s1[j] = '\0';s2[0] = '0';s2[1] = '\0';}
       else
       {
...
void read2(char s[])
{
    ...
    for(i = 0;i < len; i++)
       ...
       else if(k == len-1){for(j = 0; j < len-1; j++)ss1[j] = '0';ss1[j] = '\0';ss2[0] = '0';ss2[1] = '\0';}
       else
       {
...
void addfloat(char t1[],char t2[])
{
    ...
    if(len < num)
    {
        for(i = 0; i < num; i++)t1[i+num-len1] = t1[i];
        for(i = 0; i < num-len1; i++)t1[i] = '0';t1[num] = '\0';
        for(i = 0; i < num; i++)t2[i+num-len2] = t2[i];
