...
int main()
{
    long long int i=0,k=0,j=0,a=0,b=0,qi=0,qr=0,c[100000]={0};
    char s[100000];
    int sign1=1,sign2=1,l=0;#include<stdio.h>
#include<string.h>
#include<math.h>
int main()
{
    long long int a=0,b=0,qi=0,qr=0,c[100000]={0};
    char s[100000];
    int i=0,k=0,j=0;
    int sign1=1,sign2=1,l=0;
    scanf("%s",s);
    l=strlen(s);
    if(s[0]=='-')
    {
