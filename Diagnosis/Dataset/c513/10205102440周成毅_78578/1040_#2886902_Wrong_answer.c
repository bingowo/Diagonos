...
int main() {
    ...
    if (c == "?") {
        ...
        if (xx[0] == "O")printf("O O {O}\n");
        else if (xx[0] == "B")printf("%s %s {B,O}\n", a, b);
        else if (xx[0] == "AB" && xx[1] == "AB") printf("%s %s {A,AB,B}\n", a, b);
        else if (xx[0] == "AB" && xx[1] == "B") printf("%s %s {A,AB,B}\n", a, b);
        else if (xx[0] == "AB" && xx[1] == "O") printf("%s %s {A,B}\n", a, b);
        else if (xx[0] == "A" && xx[1] == "A") printf("%s %s {A,O}\n", a, b);
        else if (xx[0] == "A" && xx[1] == "AB") printf("%s %s {A,AB,B}\n", a, b);
        else if (xx[0] == "A" && xx[1] == "B") printf("%s %s {A,AB,B,O}\n", a, b);
        else if (xx[0] == "A" && xx[1] == "O") printf("%s %s {A,O}\n", a, b);
    } else if (a == "?") {
        char yy[2][15];
        strcpy(yy[0], b);
        strcpy(yy[1], c);
