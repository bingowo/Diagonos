...
#include <ctype.h>
 ...
 void jian(int a1[1000],int b1[1000],int a2[1000],int b2[1000],int w,int n,int n1,int n2)
 {
     int a,i,j;
     int a3[1001]={0},b3[1001]={0};
     for(j=0;j<n1/2;j++)
        {
            a=a1[j];
            a1[j]=a1[n1-1-j];
...
int main()
{
    int a1[1000]={0},a2[1000]={0},b1[1000]={0},b2[1000]={0},n;
