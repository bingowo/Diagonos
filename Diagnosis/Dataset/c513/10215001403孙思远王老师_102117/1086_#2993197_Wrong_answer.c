...
#include <ctype.h>
 ...
 void jian(int a1[31],int b1[31],int a2[31],int b2[31],int w,int n,int n1,int n2)
 {
     int a,i,j;
     int a3[32]={0},b3[32]={0};
     for(j=0;j<n1/2;j++)
...
int main()
{
    int a1[31]={0},a2[31]={0},b1[31]={0},b2[31]={0},n;
    char s1[32],s2[32];
    scanf("%s%s%d",s1,s2,&n);
    int i,j1,j2,n1,n2;
    ...
    if(j1<j2)
        w=j2;
    char aa1[32]={'0'},aa2[32]={'0'},bb1[32]={'0'},bb2[32]={'0'};
    for(i=0;i<30;i++)
    {
        aa1[i]=a1[i]+'0';
        aa2[i]=a2[i]+'0';
