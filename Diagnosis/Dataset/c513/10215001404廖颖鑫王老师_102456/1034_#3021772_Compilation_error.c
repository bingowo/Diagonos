...
int cmp(const void *a,const1 void *b)
{
    LETTER *x=(LETTER*)a;
    LETTER *y=(LETTER*)b;
...
int main()
{
    ...
    for(i=0;i<T;i++)
    {
        float a[26]={8.19,1.47,3.83,3.91,2.25,2.26,1.71,4.57,7.10,0.14,0.41,3.77,3.34,7.06,7.26,2.89,0.09,6.85,6.36,9.41,2.58,1.09,1.59,0.21,1.58,0.08};
        LETTER let[100];
