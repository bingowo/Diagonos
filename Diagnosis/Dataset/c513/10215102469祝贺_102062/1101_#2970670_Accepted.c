...
void solve3(char*s1,char*s2){
    ...
    else if((a1=='A' && a2=='A') && (b1=='-' && b2=='-')) strcpy(o1,"{A-,O-}");
    else if((a1=='A' && a2=='A') && !(b1=='-' && b2=='-')) strcpy(o1,"{A+,A-,O+,O-}");
    else if((a1=='B' && a2=='B') && (b1=='-' && b2=='-')) strcpy(o1,"{B-,O-}");
    else if((a1=='B' && a2=='B') && !(b1=='-' && b2=='-')) strcpy(o1,"{B+,B-,O+,O-}");
    else if((a1=='C' && a2=='C') && (b1=='-' && b2=='-')) strcpy(o1,"{A-,AB-,B-}");
    else if((a1=='C' && a2=='C') && !(b1=='-' && b2=='-')) strcpy(o1,"{A+,A-,AB+,AB-,B+,B-}");
...
void solve(int pos, char* s, char*s3){
    ...
    if(pos==1 && strcmp(o1,"impossible")!=0)printf("{%s} %s %s\n",o1,s,s3);
    else if(pos!=1 && strcmp(o1,"impossible")!=0) printf("%s {%s} %s\n",s,o1,s3);
    else if(pos==1) printf("%s %s %s\n",o1,s,s3);
    else printf("%s %s %s\n",s,o1,s3);
}
int main(){
    int pro;
