...
void findson(){
	...
	else if(strcmp(buf[0],"A")==0 && strcmp(buf[1],"O")==0) printf("{A,AB,B}");
	else if(strcmp(buf[0],"AB")==0 && strcmp(buf[1],"O")==0) printf("{A,B}");
	else if(strcmp(buf[0],"B")==0 && strcmp(buf[1],"O")==0) printf("{B,O}");
	else if(strcmp(buf[0],"AB")==0 && strcmp(buf[1],"B")==0) printf("{AB,B}");
	else if(strcmp(buf[0],"A")==0 && strcmp(buf[1],"B")==0) printf("{A,AB,B,O}");
	else if(strcmp(buf[0],"A")==0 && strcmp(buf[1],"AB")==0) printf("{A,AB}");
}
void findparent(){
	int i=0;
	...
	else if(strcmp(buf[2],"A")==0 && strcmp(buf[i],"AB")==0) printf("{A,AB,O} ");
	else if(strcmp(buf[2],"A")==0 && strcmp(buf[i],"B")==0) printf("{A} ");
	else if(strcmp(buf[2],"A")==0 && strcmp(buf[i],"O")==0) printf("{A,AB} ");
	else if(strcmp(buf[2],"B")==0 && strcmp(buf[i],"A")==0) printf("{B} ");
	else if(strcmp(buf[2],"B")==0 && strcmp(buf[i],"B")==0) printf("{A,AB,B,O} ");
	else if(strcmp(buf[2],"B")==0 && strcmp(buf[i],"AB")==0) printf("{B,AB,O} ");
	else if(strcmp(buf[2],"B")==0 && strcmp(buf[i],"O")==0) printf("{B,AB} ");
	else if(strcmp(buf[2],"AB")==0 && strcmp(buf[i],"O")!=0) printf("{AB} ");
	else if(strcmp(buf[2],"AB")==0 && strcmp(buf[i],"O")==0) printf("impossible ");
	else if(strcmp(buf[2],"O")==0 && strcmp(buf[i],"A")==0) printf("{A,O} ");
	else if(strcmp(buf[2],"O")==0 && strcmp(buf[i],"B")==0) printf("{B,O} ");
	else if(strcmp(buf[2],"O")==0 && strcmp(buf[i],"O")==0) printf("{O} ");
