...
void next(){
	...
	if(len1 == 1 && len2 == 1){
		...
		if(c1[0] != c2[0]){
			c3[0] = '{'; c3[1] = 'A'; c3[2] = ',';
			c3[3] = 'B'; c3[4] = ',';c3[5] = 'O';c3[6] = '}';c3[7] = '\n';
		}
	}
	if(len1 != len2){
		if(c1[0] == c2[0]){
			c3[0] = '{'; c3[1] = 'A'; c3[2] = ',';
			c3[3] = 'A'; c3[4] = 'B';c3[5] = '}';c3[6] = '\n';
		}
		if(c1[0] != c2[0]){
			c3[0] = '{'; c3[1] = 'A'; c3[2] = 'B';
			c3[3] = ','; c3[4] = 'B';c3[5] = '}';c3[6] = '\n';
		}
	}
	if(len1 == 2 && len2 == 2){
		c3[0] = '{'; c3[1] = 'A'; c3[2] = ',';
		c3[3] = 'A'; c3[4] = 'B';c3[5] = ',';c3[6] = 'B'; c3[7] = '}';c3[8] = '\n';
	}
}
int main(){
