...
int main(){
    ...
    if (strcmp(child, "?")==0){
        if (strcmp(dad, "A")==0){
            ...
            else if (strcmp(mom, "B")==0) strcpy(child, "{B}");
        ...
        if (strcmp(b, "A")==0){
            ...
            else if (strcmp(child, "B")==0) strcpy(a, "{B}");
            ...
            else if (strcmp(child, "B")==0) strcpy(a, "{A,B,O}");//finish
            else if (strcmp(child, "O")==0) strcpy(a, "{A,AB,B,O}");
        }
