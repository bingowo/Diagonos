...
int main()
{
	...
	unsigned long long pow262=4611686018427387904;
	
	scanf("%d",&points);
	for(i=0;i<points;i++)scanf("%lld %lld",&data[i][0],&data[i][1]);
	qsort(data,points,2*sizeof(long long),cmp);
	if(llabs(data[0][0])==pow262&&llabs(data[0][1])==pow262&&llabs(data[1][0])==pow262&&llabs(data[1][1])==pow262&&data[0][0]==-data[1][0]&&data[0][1]==-data[1][1])printf("18446744073709551616\n");
