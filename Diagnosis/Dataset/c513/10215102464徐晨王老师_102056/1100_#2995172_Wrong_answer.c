    ...
    for(int i=0;i<q;i++){
        ...
        if(a*step[len-1][0]>=0&&b*step[len-1][1]>=0){
            if(rem1==0&&rem2==0)flag=1;
                ...
                if(step[len-1][0]==0&&step[len-1][1]==0){flag=flag;}
                else{
                    while((rem1-step[len-1][0])*a>=0&&(rem2-step[len-1][1])*b>=0){
                        if((rem1-step[len-1][0])*step[len-1][0]>=0&&(rem2-step[len-1][1])*step[len-1][1]>=0){
