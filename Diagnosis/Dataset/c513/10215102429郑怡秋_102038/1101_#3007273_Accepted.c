...
void solve()
{
	...
	if(!strcmp(F,"?"))
	{
		if(M[m]=='-'&&S[s]=='+')
		{
			if(!strncmp(M,"A",m))
			{
				if(!strncmp(S,"A",s)) printf("{A+,AB+,B+,O+} %s %s\n",M,S);
				else if(!strncmp(S,"B",s)) printf("{AB+,B+} %s %s\n",M,S);
				else if(!strncmp(S,"O",s)) printf("{A+,B+,O+} %s %s\n",M,S);
				else if(!strncmp(S,"AB",s)) printf("{AB+,B+} %s %s\n",M,S);
			}
			else if(!strncmp(M,"B",m))
			{
				if(!strncmp(S,"A",s)) printf("{A+,AB+} %s %s\n",M,S);
				else if(!strncmp(S,"B",s)) printf("{A+,AB+,B+,O+} %s %s\n",M,S);
				else if(!strncmp(S,"O",s)) printf("{A+,B+,O+} %s %s\n",M,S);
				else if(!strncmp(S,"AB",s)) printf("{A+,AB+} %s %s\n",M,S);
			}
			else if(!strncmp(M,"O",m))
			{
				if(!strncmp(S,"A",s)) printf("{A+,AB+,AB-} %s %s\n",M,S);
				else if(!strncmp(S,"B",s)) printf("{AB+,B+} %s %s\n",M,S);
				else if(!strncmp(S,"O",s)) printf("{A+,A,B+,O+} %s %s\n",M,S);
			...
			else if(!strncmp(M,"AB",m))
			{
				...
				else if(!strncmp(S,"AB",s)) printf("{A+,AB+,B+} %s %s\n",M,S);
			}
		}
		else
		if(!strncmp(M,"A",m))
	...
	else if(!strcmp(M,"?"))
	{
		if(F[f]=='-'&&S[s]=='+')
		{
			if(!strncmp(F,"A",f))
			{
				if(!strncmp(S,"A",s)) printf("%s {A+,AB+,B+,O+} %s\n",F,S);
				else if(!strncmp(S,"B",s)) printf("%s {AB+,B+} %s\n",F,S);
				else if(!strncmp(S,"O",s)) printf("%s {A+,B+,O+} %s\n",F,S);
				else if(!strncmp(S,"AB",s)) printf("%s {AB+,B+} %s\n",F,S);
			}
			else if(!strncmp(F,"B",f))
			{
				if(!strncmp(S,"A",s)) printf("%s {A+,AB+} %s\n",F,S);
				else if(!strncmp(S,"B",s)) printf("%s {A+,AB+,B+,O+} %s\n",F,S);
				else if(!strncmp(S,"O",s)) printf("%s {A+,B+,O+} %s\n",F,S);
				else if(!strncmp(S,"AB",s)) printf("%s {A+,AB+} %s\n",F,S);
			}
			...
			else if(!strncmp(F,"AB",f))
			{
				...
				else if(!strncmp(S,"AB",s)) printf("%s {A+,AB+,B+} %s\n",F,S);
			}
		}
		else
		if(!strncmp(F,"A",f))
