...
int main()
{
	...
	else
	{
		...
		for(int i=0;i<k1;i++)
		{
			for(int j=0;j<k2;j++)
			{
				if(an[i][0]*cn[j][0]+an[i][1]*cn[j][1]==a[1]) 
				{
					int a0,c0;
					a1=an[i][0];c2=cn[j][0];a2=an[i][1];c1=cn[j][1];
					if(a1>a2) a0=a1,a1=a2,a2=a0,c0=c1,c1=c2,c2=c0;
					else if(a1==a2&&c1>c2)  c0=c1,c1=c2,c2=c0;
					tump=1;
					break;
				}
				else if(an[i][1]*cn[j][0]+an[i][0]*cn[j][1]==a[1])
				{
					int a0,c0;
					a1=an[i][1];c2=cn[j][0];a2=an[i][0];c1=cn[j][1];
					if(a1>a2) a0=a1,a1=a2,a2=a0,c0=c1,c1=c2,c2=c0;
					else if(a1==a2&&c1>c2)  c0=c1,c1=c2,c2=c0;
					tump=1;
					break;
