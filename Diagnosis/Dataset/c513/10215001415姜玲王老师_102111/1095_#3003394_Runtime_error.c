...
int main()
{
   char a[100];
   scanf("%s",a);
   int b[16][4]={{0,1,0,1},{1,0,0,1},{1,-1,1,1},{0,1,1,1},{0,1,2,-1},{1,1,2,-1},{1,-1,1,-1},{0,1,1,-1},{2,1,2,1},{3,1,2,1},{1,1,3,1},{2,1,3,1},{2,1,0,1},{3,1,0,1},{1,1,1,1},{2,1,1,1}};
