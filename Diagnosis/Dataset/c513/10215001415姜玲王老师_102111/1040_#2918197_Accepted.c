...
{if(a==1&&b==1) printf("{A,AB,B,O} ");
if(a==1&&b==2) printf("{AB,B} ");
if(a==1&&b==3) printf("{AB,B} ");
...
if(a==1&&b==2) printf("{A,AB,B}");
if(a==1&&b==3) printf("{A,AB,B,O} ");
if(a==1&&b==4) printf("{A,O} ");
if(a==2&&b==1) printf("{A,AB,B}");
if(a==2&&b==2) printf("{A,AB,B}");
if(a==2&&b==3) printf("{A,AB,B} ");
if(a==2&&b==4) printf("{A,B} ");
if(a==3&&b==1) printf("{A,AB,B,O}");
if(a==3&&b==2) printf("{A,AB,B} ");
