...
int main()
{
   ...
   if(strlen(c0)==1&&c0[0]=='0'&&strlen(c1)==1&&c1[0]=='0') {printf("0");return 0;}
   if(strlen(c0)!=1||c0[0]!='0')
   {
       if(flag1<0) printf("-");
       for(i=0;i<strlen(c0);i++){printf("%c"),c0[strlen(c0)-i-1];}
       if(flag2>0&&(strlen(c1)!=1||c1[0]!='0')) printf("+");

   }
   if(strlen(c1)!=1||c1[0]!='0')
   {
       if(flag2<0) printf("-");
       if(!strcmp(c1,"1")){printf("i");return 0;}
       for(i=0;i<strlen(c1);i++){printf("%c"),c1[strlen(c1)-i-1];}
       printf("i");
   }
