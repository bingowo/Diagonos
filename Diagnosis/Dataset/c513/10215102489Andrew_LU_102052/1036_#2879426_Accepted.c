...
int main(){
	...
	if((a[0].x>=0 && a[1].x<=0) || (a[0].x<=0 && a[1].x>=0)){
		...
		if(llabs(a[0].x)>llabs(a[1].x))
			t1[0]=llabs(a[0].x)-llabs(a[1].x);
		else t1[0]=llabs(a[1].x)-llabs(a[0].x);
	}
	if((a[0].y>=0 && a[1].y<=0) || (a[0].y<=0 && a[1].y>=0)){
		...
		if(llabs(a[0].y)>llabs(a[1].y))
			t2[0]=llabs(a[0].y)-llabs(a[1].y);
		else t2[0]=llabs(a[1].y)-llabs(a[0].y);
	}
	if(t1[0]!=9223372036854775808 || t2[0]!=9223372036854775808){
		...
		for(i=0;i<n-1;i++){
			if((a[i].x>=0 && a[i+1].x<=0) || (a[i].x<=0 && a[i+1].x>=0)){
				...
				if(llabs(a[i].x)>llabs(a[i+1].x))
				 t1[i]=llabs(a[i].x)-llabs(a[i+1].x);
				else t1[i]=llabs(a[i+1].x)-llabs(a[i].x);
			}
			if((a[i].y>=0 && a[i+1].y<=0) || (a[i].y<=0 && a[i+1].y>=0)){
				...
				if(llabs(a[i].y)>llabs(a[i+1].y))
				 t2[i]=llabs(a[i].y)-llabs(a[i+1].y);
				else t2[i]=llabs(a[i+1].y)-llabs(a[i].y);
			}
