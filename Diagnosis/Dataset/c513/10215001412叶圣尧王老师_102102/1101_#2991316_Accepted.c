...
void val1(char b[],char c[])
{
    ...
    else if(strcmp(b,"B-")==0&&strcmp(c,"A+")==0)printf("{A+,AB+}");
    ...
    else if(strcmp(b,"A-")==0&&strcmp(c,"AB+")==0)printf("{AB+,B+}");
...
void val2(char a[],char c[])
{
    ...
    else if(strcmp(a,"B-")==0&&strcmp(c,"A+")==0)printf("{A+,AB+}");
    ...
    else if(strcmp(a,"A-")==0&&strcmp(c,"AB+")==0)printf("{AB+,B+}");
