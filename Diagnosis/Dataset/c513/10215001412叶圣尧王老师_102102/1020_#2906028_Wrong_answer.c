...
int cmp2(const void*a,const void *b)
{
    struct st*c=(struct st*)a;
    struct st*d=(struct st*)b;
    if(strcmp(c->size,d->size)==0)return strcmp(c->name,d->name);
    else return strcmp(c->size,d->size);
}
...
int cmp3(const void*a,const void *b)
{
    ...
    else if(strcmp(c->data,d->data)==0&&strcmp(c->time,d->time)==0)return strcmp(c->name,d->name);
    else if(strcmp(c->data,d->data)==0&&strcmp(c->time,d->time)!=0)return strcmp(c->time,d->time);
}
