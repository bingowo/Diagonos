...
int main()
{
    ...
    else if((s1[dot+num+1]+s2[dot+num+1]-'0'-'0')==14 && (s1[dot+num+2]+s2[dot+num+2]-'0'-'0')>=10) left=2; 
    else if((s1[dot+num+1]+s2[dot+num+1]-'0'-'0')==13 && (s1[dot+num+2]+s2[dot+num+2]-'0'-'0')>=15) left=2;
