...
int main()
{
    ...
    if(k==0) {num1=rain;num2=NL[0].num;}
    for(int i=0;i<=k-1;i++)
    {
    ...
    if(rain>0) {num1=rain;num2=width;}
    if(num1==0 && num2==0 && rain==0) printf("%d",res);
	else if(res+num1/num2==0 && num1%num2==0) printf("0");
	else if(res+num1/num2==0) printf("%d/%d",(num1%num2)/GCD(num1%num2,num2),num2/GCD(num1%num2,num2));
	else if(num1%num2==0)printf("%d",res+num1/num2);
	else printf("%d+%d/%d",res+num1/num2,(num1%num2)/GCD(num1%num2,num2),num2/GCD(num1%num2,num2));
    free(L);
    free(NL);
    return 0;
}