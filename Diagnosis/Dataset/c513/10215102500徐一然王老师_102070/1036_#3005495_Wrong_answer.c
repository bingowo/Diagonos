...
int main()
{
    ...
    if(A[0].x<=0&&A[1].x<=0)temp1=-A[0].x-A[1].x;
    else if(A[0].x>=0&&A[1].x<=0){temp1=A[0].x-A[1].x;}
    else if(A[0].x<=0&&A[1].x>=0)temp1=-A[0].x+A[1].x;
    else temp1=A[0].x+A[1].x;
    if(A[0].y<=0&&A[1].y<=0)temp2=-A[0].y-A[1].y;
    else if(A[0].y>=0&&A[1].y<=0)temp2=A[0].y-A[1].y;
    else if(A[0].y<=0&&A[1].y>=0)temp2=-A[0].y+A[1].y;
    else temp2=A[0].y+A[1].y;
    temp=temp1+temp2;
    printf("%llu\n",temp);
    /*for(int i=0;i<n;i++)
    {
    ...
    for(int i=0;i<n-1;i++)
    {
        ...
        {
            if(A[i].y<=0&&A[i+1].y<=0)t=-A[i].y-A[i+1].y;
            else if(A[i].y>=0&&A[1+i].y<=0)t=A[i].y-A[i+1].y;
            else if(A[i].y<=0&&A[1+i].y>=0)t=-A[i].y+A[i+1].y;
            else t=A[i].y+A[1+i].y;

            if(A[i].x<=0&&A[i+1].x<=0)t1=-A[i].x-A[i+1].x;
            else if(A[i].x>=0&&A[1+i].x<=0)t1=A[i].x-A[i+1].x;
            else if(A[i].x<=0&&A[1+i].x>=0)t1=-A[i].x+A[i+1].x;
            else t1=A[i].x+A[1+i].x;
        ...
        {
            if(A[i].x<=0&&A[i+1].x<=0)t=-A[i].x-A[i+1].x;
            else if(A[i].x>=0&&A[1+i].x<=0)t=A[i].x-A[i+1].x;
            else if(A[i].x<=0&&A[1+i].x>=0)t=-A[i].x+A[i+1].x;
            else t=A[i].x+A[1+i].x;

            if(A[i].y<=0&&A[i+1].y<=0)t1=-A[i].y-A[i+1].y;
            else if(A[i].y>=0&&A[1+i].y<=0)t1=A[i].y-A[i+1].y;
            else if(A[i].y<=0&&A[1+i].y>=0)t1=-A[i].y+A[i+1].y;
            else t1=A[i].y+A[1+i].y;
            t=t1+t;
            if(t%2==0)break;
            t=t+1;
            if((t-2)%4!=0);
