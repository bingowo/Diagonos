...
int main()
{
    ...
    {
        char c;int i=0;char str[10];int cnt=0,flag=1;
        printf("case #%d:\n",cas);
        while((c=getchar())!='\n')
        {
            switch(i)
            {
                ...
                {
                    if(c!='/')str[cnt++]=c;
                    else {str[cnt]='\0';print(str);i=1;flag=0;}
                    break;
                }
                case 1:
                {
                    if(c!='/'){cnt=0;str[cnt++]=c;i=0;flag=1;}
                    else i=2;
                    break;
                }
                case 2: {i=3;break;}
                case 3: 
                {
                    if(c!='/'){printf(" ");cnt=0;str[cnt++]=c;i=0;flag=1;}
                    else i=4;
                    break;
                }
                case 4: {printf(".");i=5;break;}
                case 5: {cnt=0;str[cnt++]=c;i=0;flag=1;}
            }   
        }
        if(flag){str[cnt]='\0';print(str);}
        printf("\n");
    }
    return 0;
}