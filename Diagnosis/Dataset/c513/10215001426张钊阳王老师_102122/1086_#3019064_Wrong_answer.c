...
int main()
{
    ...
    scanf("%s %s",a11,b11);
    int ii=0,cnta=0,cntb=0;
    while(a11[ii]=='0') {cnta++;ii++;}
    for(int gg=cnta,i=0;gg<strlen(a11);gg++,i++) a1[i]=a11[gg];
    ii=0;
    while(b11[ii]=='0') {cntb++;ii++;}
    for(int gg=cntb,i=0;gg<strlen(b11);gg++,i++) b1[i]=b11[gg];
