...
int main(){
    ...
    for(int i=0;i<500;i++){
        if(A.zhengshu[i]!=-1) printf("%d",A.zhengshu[i]);
        }
    printf(".");
    for(int i=0;i<N;i++){
        if(A.xiaoshu[i]>=0) printf("%d",A.xiaoshu[i]);
        else printf("%d",0);
    }
    printf("\n");
    for(int i=0;i<500;i++){
        if(B.zhengshu[i]!=-1) printf("%d",B.zhengshu[i]);
    }
    printf(".");
    for(int i=0;i<N;i++){
        if(B.xiaoshu[i]>=0) printf("%d",B.xiaoshu[i]);
        else printf("%d",0);
    }
    printf("\n");
