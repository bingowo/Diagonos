...
int main()
{
    ...
    if(kid[0]=='?')
    {
        ...
        {
            kid[0]='{';kid[1]='A';kid[2]='B';kid[3]=',';
            kid[4]='A';kid[5]=',';kid[6]='B';kid[7]='}';
            kid[8]='\0';
        }
        else if((dad_len==2&&mom[0]=='A')||(dad[0]=='A'&&mom_len==2))
        {
            kid[0]='{';kid[1]='A';kid[2]='B';kid[3]=',';
            kid[4]='A';kid[5]='}';kid[6]='\0';
        }
    ...
    else
    {
        if(kid_len==2)
        {
            if(dad_len==2)
            {
                ...
                mom[4]='A';mom[5]=',';mom[6]='B';mom[7]='}';
                mom[8]='\0';
            }
            if(mom_len==2)
            {
                dad[0]='{';dad[1]='A';dad[2]='B';dad[3]=',';
                dad[4]='A';dad[5]=',';dad[6]='B';dad[7]='}';
                dad[8]='\0';
            }
            if(dad_len==1&&mom_len==1)
            {
                ...
                {
                    mom[0]='{';mom[1]='A';mom[2]='B';mom[3]=',';
                    mom[4]='A';mom[5]='}';mom[6]='\0';
                }
                if(mom[0]=='B')
                {
                    dad[0]='{';dad[1]='A';dad[2]='B';dad[3]=',';
                    dad[4]='A';dad[5]='}';dad[6]='\0';
                }
