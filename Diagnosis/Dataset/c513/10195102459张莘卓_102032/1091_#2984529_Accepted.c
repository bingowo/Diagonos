...
NUM calculate(NUM* t1, NUM* t2, int flag);
...
NUM calculate(NUM* t1, NUM* t2, int flag) {
    if(flag == -1) {
        if(t1->flag == t2->flag) return minus(t1, t2);
        else {
            t2->flag = t1->flag;
            return plus(t1, t2);
        }
    }else
        if(t1->flag == t2->flag) return plus(t1, t2);
        else if(t2->flag == -1) {
            t2->flag = 1;
            return minus(t1, t2);
        }else {
