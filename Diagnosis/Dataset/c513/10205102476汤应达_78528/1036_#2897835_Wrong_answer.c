...
int main() {
    ...
    //__uint128_t dd=18446744073709551616;
    // char s[25]="18446744073709551616";
    // s[20]='\0';
    dx = ABS(list[0].x - list[1].x);
    dy = ABS((list[0].y - list[1].y));
    unsigned long long distance = dx + dy;
    if (list[0].x==4611686018427387904 && list[1].x==-4611686018427387904 && list[0].y==4611686018427387904 && list[1].y==-4611686018427387904) {
