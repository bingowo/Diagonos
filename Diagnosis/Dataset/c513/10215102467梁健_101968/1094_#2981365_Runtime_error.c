    ...
    if(isdigit(a[n-1].s[0])&&isdigit(a[0].s[0])){
        ...
        int startp=len2-1;
            for(int i=0;i<strlen(A);i++){
                if(A[i]!='0'&&isdigit(A[i])){
                    startp=i;
                    break;
                }
            }
            for(int i=startp;i<strlen(A);i++)printf("%c",A[i]);
            printf("\n");
    }
        ...
        int startp=len2-1;
            ...
            for(int i=startp;i<len2;i++)printf("%c",A[i]);
            printf("\n");
    }
    else{
        for(int i=0;i<strlen(a[0].s)-1;i++){
        ...
        if(len1>len2){
            ...
            len1=strlen(A);len2=strlen(B);
            for(int i=0;i<len2;i++)d[i]=B[len2-i-1];
            strcpy(B,d);
            int startp=len2-1;
            for(int i=0;i<strlen(B)&&isdigit(B[i]);i++){
                if(B[i]!='0'){
                    startp=i;
                    break;
                }
            }
            for(int i=startp;i<strlen(B);i++)printf("%c",B[i]);
            printf("\n");
        }
    }
    return 0;
