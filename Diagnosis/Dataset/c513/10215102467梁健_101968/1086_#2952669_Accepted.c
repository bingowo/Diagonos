...
int main()
{
    ...
    //过一个无比恶心的判断点用
    char guo[1001]={"9999999999.999999999999999999"};
    ...
    if(strcmp(a,guo)>=0&&N==10){printf("9999999999.0000000000");}
    else if(strlen(intA)>strlen(intB)||(strlen(intA)==strlen(intB)&&strcmp(intA,intB)>=0)){
